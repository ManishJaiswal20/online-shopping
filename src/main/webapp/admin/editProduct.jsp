...
<body>
 <h2><a class="back" href="allProductEditProduct.jsp"><i class='fa  fa-arrow-left'> Back</i></a></h2>
...
<option value="No">No</option>
 ...
 <button class="button">Save <i class='fa fa-fw fa-arrow-circle-right'></i></button>
</form>
